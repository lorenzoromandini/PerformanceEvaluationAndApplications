...
plt.bar(x_1, y_1)
plt.xlabel("Cars")
plt.suptitle(f"Distribution of the number of cars in the road segment")
plt.show()
...
plt.suptitle(f"Response time distribution")
plt.show()
...
plt.suptitle(f"Service time distribution")
plt.show()
